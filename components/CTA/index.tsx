          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Launch with iManage for Streamlined Success
              </h2>
              <p>
                Join iManage for simplicity in your cleaning business success. Let's navigate efficiency and conquer streamlined operations together.
              </p>
            </motion.div>
            <motion.div
              variants={{
